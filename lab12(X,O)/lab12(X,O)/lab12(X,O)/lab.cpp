...
int main() {
	...
	Texture f;
	f.loadFromFile("C:/Users/Дождиков Роман/Desktop/lab12(X,O)/lab12(X,O)/Paint/fon.png");
	Sprite fon(f);

	Texture c;
	c.loadFromFile("C:/Users/Дождиков Роман/Desktop/lab12(X,O)/lab12(X,O)/Paint/crnol.png");
	Sprite vibor[2];
	for (int i = 0; i < 2; i++) {
	...
	Texture l;
	l.loadFromFile("C:/Users/Дождиков Роман/Desktop/lab12(X,O)/lab12(X,O)/Paint/line.png");
	Sprite line(l);
